      ...
      child: TextButton(
        ...
        style: TextButton.styleFrom(
          ...
          shape: RoundedRectangleBorder(
            side: BorderSide(color: _setColor == Colors.white ? Colors.black : Colors.white),
            borderRadius: BorderRadius.circular(20),

          ),
        ),
        child: Text("Add to Cart", style: TextStyle(color: _setColor == Colors.white ? Colors.black : Colors.white),),
      ),
    );
  }
